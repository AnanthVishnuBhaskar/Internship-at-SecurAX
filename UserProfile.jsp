        ...
        <!-- Left col -->
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> USER PROFILE</li>
            ...
            <div class="tab-content no-padding">
              ...
              <br>
               <form action="ChekLoginData" method="post">
...
<input type="button" value="Change Password" class="buttonClass" style="width: auto;" onclick="slideDownTr()">
</td>
</tr>
...
<input class="inputs"   type="password" id="user_password" name="user_password" required="required">	  
...
<input type="submit" value="Update password" class="buttonClass" style="width: auto;">
</td>
<td>

 
<input type="hidden" name="user_id" id="user_id" value="<%=userid%>">
<input type="hidden" name="request" value="updatePassword">
</td>
</tr>
</table>
...
<input class="inputs"   type="email" id="user_email" name="user_email" required="required">	  
 ...
 <tr>
  ...
  <td  >
		SecurAX Email Password :
		</td>
		<td style="height: auto;">
	 
<input class="inputs"   type="password" id="user_email_password" name="user_email_password" required="required">	  
...
<input type="submit" value="Update Email" class="buttonClass" style="width: auto;">
</td>
<td>

 
<input type="hidden" name="user_id" id="user_id" value="<%=userid%>">
<input type="hidden" name="request" value="updateEmail">
</td>
</tr>
</table>
 </form>
