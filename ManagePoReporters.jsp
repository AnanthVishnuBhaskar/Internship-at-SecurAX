...
{
	 //alert(data);
        window.document.location = 'AddReporter.jsp';
...
String userName=session.getAttribute("userName").toString();
 ...
 Inventory_Po_ReportersDao po_ReportersDao =new Inventory_Po_ReportersDao();
 List<Inventory_Po_Reporters> list=po_ReportersDao.getAllReporters();
...
<form action="Controller" method="post" id='displayUserForm'>                        
 ...
 <thead>
    ...
    <tbody>  <%
int count=0;
for(Inventory_Po_Reporters item:list)
{
...
<tr>
 ...
 <td width="200px"><%=item.getReporterUserName()%></td>
   
 <td width="200px"><%=item.getReporterFirstName()%></td>
