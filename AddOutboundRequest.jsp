...
List<Inventory_Status> list=dao.getAllOutBoundStatus();
        ...
        <!-- Left col -->
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content no-padding">
              ...
              <br>
               <form action="Controller" method="post" name="addItem" id="addItem" onsubmit="return validateForm()">
...
<tr >
		<td style="width:100px">MODAL FOR CLIENT
		</td>
		...
		%>
		 ...
		 <input type="text" name="item_type" class="inputs"   readonly="readonly" id="item_type" >
		</td>
...
<tr>
		...
		<td>
		<input type="text" name="item_quantity" class="inputs" required="required" readonly="readonly" id="item_quantity" >
		</td>
		...
		for(Inventory_Status type:list)
		{
			%>
...
<tr class="hideTr">
	...
	Quantity for Client
		...
		<td>
		<input type="number" name="quantity_for_client" class="inputs" required="required"  id="quantity_for_client" onblur="validateForm()">
		</td>
  	<td>
	 Price
		</td>
		<td>
		<input type="number" name="outbound_item_price" class="inputs" required="required"  >
		</td>
...
<tr class="hideTr">
	...
	SERIAL NUMBER
		...
		<td>
		<input type="text" name="outbound_serial_number" class="inputs" required="required" readonly="readonly" value="SLN001">
		</td>
		...
		<td>
		 <textarea rows="5" cols="20" name="outbound_comments" class="inputs" required="required"></textarea>
		</td>
</tr>
<tr class="hideTr">
<td>

<input type="submit" value="ADD REQUEST" class="buttonClass">
</td>
<td>

 
<%-- <input type="hidden" name="item_added_by" value="<%=userid%>"> --%>
<input type="hidden" name="request" value="new_outbound">
