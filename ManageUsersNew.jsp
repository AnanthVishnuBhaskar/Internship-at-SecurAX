<!DOCTYPE html>
<%@page import="com.inventory.dao.Inventory_ReciepientsDao"%>
<%@page import="com.inventory.bean.Inventory_Recipients"%>
...
{
	 //alert(data);
        window.document.location = 'AddUser.jsp';
   
}
function callAddrecipient()
{
	 //alert(data);
        window.document.location = 'AddRecipient.jsp';
 ...
 function setId(id)
 {
	 ...
	 document.getElementById('request').value='user_display';
	 //alert(document.getElementById('request').value);
	 document.getElementById('displayUserForm').submit(); */
...
List<Inventory_Users> userList=userDao.fetchAllLoginUsers();
        ...
        <!-- Left col -->
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content no-padding">
              ...
              <br>
                        <!-- Table -->
<form action="Controller" method="post" id='displayUserForm'>                        
 ...
 <thead>
    ...
    <tbody>  <%
int count=0;
for(Inventory_Users item:userList)
{
...
<tr>
 ...
 <td width="200px"><%=item.getUserName()%></td>
   
 <td width="200px"><%=item.getUserFirstName()%></td>
  <td width="200px"><%=item.getUserType() %></td>
  <td width="200px"><%=item.getUserPasword()%></td>
 ...
 <input type="hidden" name="request" id="request"> 
            ...
            <div><h3 style="background-color: #C40233;color:#FFFFFF;width: 100%">RECIEPENTS</h3></div>
              <div>
<button  onclick="callAddrecipient();" style="background-color: #2FA3E6;width: 50px;height: 30px;color: white;border: #1E95DA">+</button>
 ...
 <%
 Inventory_ReciepientsDao dao=new Inventory_ReciepientsDao();
 List<Inventory_Recipients> list=dao.getAllReciepients();
...
for(Inventory_Recipients users:list)
{
...
<tr>
 ...
 <td width="200px"><%=users.getReciepient_name()%></td>
   
 <td width="200px"><%=users.getReciepient_email()%></td>
  <td width="200px"><%=users.getReciepient_status()%></td>
...
<form action="Controller" method="post" id='editForm'>
