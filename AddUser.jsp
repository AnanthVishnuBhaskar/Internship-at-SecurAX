        ...
        <!-- Left col -->
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> ADD USER</li>
...
<tr>		
		...
		<td>
		<input type="text" name="user_password" class="inputs" required="required">
		</td>
		</tr>
<tr>
		<td>
		...
		<td>
		<select name="user_type" id="user_type" onchange="setUserStatus();" class="inputs" >
