...
<tr >
		...
		<td><input type="text" name="item_type" required="required" class="inputs"></td> 
		</tr>
		<tr height="20px">
<td>

<input type="submit" value="ADD ITEM TYPE" class="buttonClass">
</td>
<td>
...
<input type="hidden" name="request" value="addItemType">
</td>
</tr>
</table>
