...
function setId(id)
{
	 ...
	 document.getElementById('request').value='edit_user_status';
...
function setIdForDelete(id)
{
	...
	{
		     document.getElementById('status_id_delete').value=id;//item_id_delete
			//alert(deleteForm.item_id_delete.value);
			 deleteForm.request.value='delete_user_status';
...
List<Inventory_Users> list=(List)session.getAttribute("user_status_single");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <% 
for(Inventory_Users status:list)
{
	%>
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">
<button style="background-color: #2FA3E6;width: 50px;height: 30px;color: white;border: #1E95DA"  onclick="setId('<%=status.getUser_status_id() %>');">Edit</button>
 <button style="background-color: #CE1A01;width: 50px;height: 30px;color: white;border: #1E95DA" onclick="setIdForDelete('<%=status.getUser_status_id()  %>');">Delete</button>
...
<form id="editForm" method="post" action="Controller">
 ...
 <input type="hidden" name="request" id="request"> 
  ...
  <input type="hidden" name="status_id_delete" id="status_id_delete"> 
 <input type="hidden" name="request" id="request"> 
