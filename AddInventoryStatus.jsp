...
function sendValue()
{
	 if(document.getElementById("status_availability_checkbox").checked==true)
	 {
		 document.getElementById("status_availability").value="TRUE";
		 
	 }
	 else
	{
		 document.getElementById("status_availability").value="FALSE";
...
.buttonClass { background-color: #00AECC; /* Green */
    border: none;
    color: black;
        ...
        <!-- Left col -->
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> ADD ITEM TYPE</li>
...
<tr>
		...
		<td>
		<input type="text" name="status_name" class="inputs" required="required">
		</td>
</tr>
...
<tr>
		...
		<td>
		<select name="status_type" class="inputs" required="required">
...
<input type="checkbox" name="status_availability_checkbox"  id="status_availability_checkbox"  style="width: 20px;height: 30px" onchange="sendValue();"   >&nbsp;&nbsp;&nbsp;&nbsp;<span>IS VALID ?</span>	  
...
<input type="submit" value="ADD Status" class="buttonClass">
</td>
<td>

<input type="hidden" name="status_added_by" value="<%=userid%>">
<input type="hidden" name="request" value="add_status">
<input type="hidden" name="status_availability" id="status_availability" value="FALSE">
</td>
</tr>
</table>
</form>
