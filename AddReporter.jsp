        ...
        <!-- Left col -->
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> ADD REPORTER AND USER</li>
...
<tr>
		...
		<td>
		<input type="text" name="user_id" class="inputs" required="required">
		</td>
		<td>
		User Name : 
		</td>
		<td>
		<input type="text" name="user_name" class="inputs" required="required">
		</td>
</tr>
...
<td>
		...
		<td>
		<input type="email" name="user_email" class="inputs" required="required">
		</td>
</tr>
 <tr >
<td>

<input type="submit" value="ADD REPORTER"  class="buttonClass" style="width: auto;">
</td>
</tr> 
  
 <tr>
 <td>
<input type="hidden" name="request" value="add_reporter">
</td>
</tr>
 ...
 <form action="ControllerNew" method="post">
 <table>
...
<tr>
		...
		<td>
		<input type="text" name="user_first_name" class="inputs" required="required">
		</td>
</tr>
<tr >
		<td>
		...
		<td>
		<input type="text" name="user_password" class="inputs" value="password">
		</td>
</tr>
 <tr>
<td>
<input type="hidden" name="user_type" class="inputs" value="EMPLOYEE">
<input type="hidden" name="user_status" class="inputs" value="1">
<input type="hidden" name="request" class="inputs" value="new_user">
<input type="submit" value="ADD USER"  class="buttonClass" style="width: auto;">
</td>
</tr> 
