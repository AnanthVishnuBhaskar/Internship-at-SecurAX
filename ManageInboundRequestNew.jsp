 ...
 */
 function callAddItem()
 {
 	 //alert(data);
         ...
         window.document.location = 'AddInboundRequestNew.jsp';
    
 }
 function exportToExcel()
 {
 	 //window.document.location = 'OutboundInvoiceTable.jsp';
 	 window.open('INBOUND_TABLE.jsp', '_blank');
 ...
 function doSearch() 
 {
  ...
  function setId(id)
  {
 	// alert(id);
	    ...
	    document.getElementById('inbound_id').value = id;
		document.getElementById('request').value = 'inbound_display';
		//alert(document.getElementById('request').value);

		document.getElementById('display_ib_request').submit();
...
InboundNewDao inbound_New=new InboundNewDao();
List<Inventory_Inbound_New> list=inbound_New.getAllIBRequest();
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <button style="background-color: #2FA3E6;width: 50px;height: 30px;color: white;border: #1E95DA" onclick="callAddItem();">+</button>
         ...
         <button style="background-color: #BC002B;width: auto;height: 30px;color: white;border: #1E95DA" onclick="exportToExcel();">Export To Excel</button>
        </li> 
         ...
         <br>
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i>INBOUND REQUEST DETAILS</li>
...
for(Inventory_Inbound_New requestList:list)
{
...
<tr style="cursor: pointer;"  onclick="setId('<%=requestList.getInbound_id() %>');">
 ...
 <%=requestList.getInbound_invoice_number()%>
  ...
  <%=requestList.getInvoice_date_string()%>
  
  
  
  
  </td>
   <td width="200px"><%=requestList.getRecieve_date_string()%></td>
  <td width="200px"><%=requestList.getInbound_po()%></td>
  <td width="200px"><%=requestList.getVendor_or_transporter() %></td>
  <td width="200px"><%=requestList.getIncharge() %></td>
  <td width="200px"><%=requestList.getInvoice_amount() %></td>
...
<form action="ControllerNew" method="post" id='display_ib_request'>
