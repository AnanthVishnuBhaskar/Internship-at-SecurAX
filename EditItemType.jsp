...
<div class="functionBar">
	...
	<h3></h3> 
 <div style="position: absolute;left: 800px;width: 200px;">

 <!-- <button style="background-color: #CE1A01;width: 50px;height: 30px;color: white;border: #1E95DA" onclick="callAddItem();">Delete</button> -->
 </div>
...
<td width="200px">
  ...
  <td width="200px">
  <input type="text" name="item_type" value=" <%=item.getITEM_TYPE() %>">
 ...
 <input type="hidden" name="item_type_id" value="<%=id%>">
 
 <input type="hidden" name="request" value="from_EditItem_Type">
