...
<%=countSl %>
 ...
 int countItems=0;
 List<String> itemList=SplitingStringValues.getItemNameSerialNamesAndQuantity(req.getItem_details_added_to_Export());
 for(String dataList:itemList)
 {
	 String SingleItemValues[]=dataList.split(":");
		  itemName=SingleItemValues[0];
		  itemQuantity=SingleItemValues[1];
		  itemSerialNumbers=SingleItemValues[2];
		  countItems++;
