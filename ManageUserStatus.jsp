...
{
	 //alert(data);
        window.document.location = 'AddUserStatus.jsp';
 ...
 function setId(id)
 {
	 ...
	 document.getElementById('request').value='user_status_display';
...
List<Inventory_Users> list=dao.getAllUserStatus();
         ...
         <br>
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> USER STATUS</li>
            ...
            <div class="tab-content no-padding">
              ...
              <br><form action="Controller" method="post" id='displayStatusForm'>
                        <!-- Table -->
...
<tr style="cursor: pointer;"  onclick="setId('<%=status.getUser_status_id()%>');">

  
<td width="200px">
  
  <%=status.getUser_status()%>
  </td>
 ...
 <input type="hidden" name="request" id="request"> 
  </form>         <!--  <div style=" position:absolute;left: 800px;top: -20px;z-index: 5">
