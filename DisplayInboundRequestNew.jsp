...
%>
 ...
 List<Inventory_Inbound_New> list = (List)session.getAttribute("display_single_ib");
...
REMARK
  ...
  <%itemDetails=req.getItem_details_added_to_inventory(); %> 
...
System.out.println("String value : "+itemDetails);
List<String> itemList=s1.getItemNameQuantityAndSerialName(itemDetails);
