        ...
        <!-- Left col -->
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> ADD ITEMS</li>
...
<tr class="hideTr">
		...
		<td>
		<input type="number" name="item_quantity" class="inputs" required="required">
		</td>
...
<tr class="hideTr">
		...
		<td>
		 <textarea rows="5" cols="20" name="item_description" class="inputs" required="required"></textarea>
		</td>
</tr>
<tr class="hideTr">
<td>

<input type="submit" value="ADD ITEM" class="buttonClass">
</td>
<td>
