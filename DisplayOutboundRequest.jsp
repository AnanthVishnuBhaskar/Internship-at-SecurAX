...
%>
 ...
 List<Inventory_Outbound> list = (List)session.getAttribute("outbound_request_display");
...
%>
<%
for(Inventory_Outbound details: list)
{
	 editableStatus=details.getOUTBOUND_EDITABLE();
}
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><% 
for(Inventory_Outbound req:list)
{
	%>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">
        <% if(editableStatus.equalsIgnoreCase("FALSE") || editableStatus==null)
        		{
        ...
        <%} %>
 <button style="background-color: #CE1A01;width: 50px;height: 30px;color: white;border: #1E95DA" onclick="setIdForDelete('<%=req.getOUTBOUND_ID()%>');">Delete</button>
</li> 
      </ol> <%} %>
    </section>
