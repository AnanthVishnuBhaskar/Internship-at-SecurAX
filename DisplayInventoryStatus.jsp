...
function setId(id)
{
	 ...
	 document.getElementById('request').value='editInventoryStatus';
...
function setIdForDelete(id)
{
	...
	if (confirm("Are you sure to delete this item ..!") == true) 
	{
			...
			//alert(deleteForm.item_id_delete.value);
			 deleteForm.request.value='delete_status';
...
List<Inventory_Status> list=(List)session.getAttribute("inventory_status_single");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <%
int count=0;
    for(Inventory_Status item:list)
    {
	...
	%>
        ...
        <li class="active">
        <button style="background-color: #2FA3E6;width: 50px;height: 30px;color: white;border: #1E95DA"  onclick="setId('<%=item.getSTATUS_ID() %>');">Edit</button>
        
        <button style="background-color: #CE1A01;width: 50px;height: 30px;color: white;border: #1E95DA" onclick="setIdForDelete('<%=item.getSTATUS_ID() %>');">Delete</button>
        ...
        <!-- Left col -->
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> INVENTORY STATUS</li>
