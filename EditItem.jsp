  ...
  function setIdForDelete(id)
  {
  	...
  	if (confirm("Are you sure to delete this item ..!") == true) 
  	{
  			...
  			//alert(deleteForm.item_id_delete.value);
  			 deleteForm.request.value='delete_item';
...
<tr>
 ...
 <input type="text" name="item_description" value="<%=item.getItem_description()%>">
...
<input type="hidden" name="request" value="edit_item_description">
