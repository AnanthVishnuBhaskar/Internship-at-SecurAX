...
{
	 //alert(id);
	 document.getElementById('item_type_id').value=id;
	// alert(document.getElementById('item_type_id').value);
	 document.getElementById('request').value='edit_Item_Type';
	 //alert(document.getElementById('request').value);
	 
	document.getElementById('editItemTypeForm').submit();
...
function setIdForDelete(id)
{
	...
	if (confirm("Are you sure to delete this item ..!") == true) 
	{
			...
			//alert(deleteForm.item_id_delete.value);
			 deleteForm.request.value='delete_item_type';
...
List<Inventory_Item> list=(List)session.getAttribute("item_type_single");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><button style="background-color: #2FA3E6;width: 50px;height: 30px;color: white;border: #1E95DA"  onclick="setId('<%=item.getITEM_Type_ID() %>');">Edit</button>
 <button style="background-color: #CE1A01;width: 50px;height: 30px;color: white;border: #1E95DA" onclick="setIdForDelete('<%=item.getITEM_Type_ID()%>');">Delete</button>
</li> 
      </ol>
    </section>
  <%} %>  
...
<tr>
 ...
 <td width="200px"> <%=item.getITEM_TYPE() %>
 </td>
</tr>
...
<td width="200px">
 ...
 <form id="editItemTypeForm" method="post" action="Controller">
