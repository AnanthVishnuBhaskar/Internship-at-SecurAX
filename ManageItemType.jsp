...
{
	 //alert(data);
        window.document.location = 'AddItemType.jsp';
 ...
 function setId(id)
 {
	 ...
	 document.getElementById('request').value='item_type_display';
	 //alert(document.getElementById('request').value);
	 
document.getElementById('displayItemType').submit();
         ...
         <br>
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> ITEM TYPES</li>
            ...
            <div class="tab-content no-padding">
              ...
              <br>
                        <!-- Table -->
                        <form action="Controller" method="post" id='displayItemType'>
...
<tr >
 ...
 <td width="200px"><%=item.getITEM_ADDED_BY() %></td> 
 ...
 </div> --> <input type="hidden" name="item_type_id" id="item_type_id"> 
