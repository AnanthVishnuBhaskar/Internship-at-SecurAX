        ...
        <!-- Left col -->
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> ADD USER STATUS</li>
...
<tr >
		<td style="width:100px">USER STATUS</td>
	
		<td><input type="text" name="status_name" class="inputs" required="required"></td> 
		</tr>
		<tr height="20px">
<td>

<input type="submit" value="ADD USER STATUS" class="buttonClass">
</td>
<td>
...
<input type="hidden" name="request" value="add_user_status">
</td>
</tr>
</table>
