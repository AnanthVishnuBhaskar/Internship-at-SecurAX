...
//List<Inventory_Inbound> list=dao.geInboundRequestList();
List<Inventory_Inbound> list=dao.getIBFullRequestDetails();
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><button style="background-color: #2FA3E6;width: 50px;height: 30px;color: white;border: #1E95DA" onclick="callAddItem();">+</button></li> 
         ...
         <br>
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> INBOUND REQUEST</li>
...
for(Inventory_Inbound requestList:list)
{
...
<tr style="cursor: pointer;"  onclick="setId('<%=requestList.getINBOUND_ID() %>');">
 ...
 <%=requestList.getMODEL_NAME() %>
  ...
  <%=requestList.getVENDOR_NAME() %>
  
  
  
  
  </td>
   <td width="200px"><%=requestList.getDateTostring()%></td>
  <td width="200px"><%=requestList.getINBOUND_STATUS() %></td>
