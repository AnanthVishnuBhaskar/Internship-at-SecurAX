 ...
 */
 ...
 {
 	 //alert(data);
       //  window.document.location = 'AddOutboundRequest.jsp';
...
List<Inventory_Outbound> list=dao.getOBFullRequestDetails();
...
for(Inventory_Outbound requestList:list)
{
...
<tr style="cursor: pointer;"  onclick="setId('<%=requestList.getOUTBOUND_ID() %>');">
 ...
 <%=requestList.getITEM_FOR_CLIENT() %>
  ...
  <td width="200px"><%=requestList.getOUTBOUND_STATUS() %></td>
