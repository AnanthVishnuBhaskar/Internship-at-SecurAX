        ...
        <!-- Left col -->
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header">EDIT ITEM</li>
...
<td width="200px" align="center">
  ...
  <td width="200px" >
  <input type="text" name="status_name" value=" <%=item.getSTATUS_NAME()%>">
...
<td width="200px" align="center">
  ...
  <%-- 
  <input type="text" name="status_type" value="<%=item.getSTATUS_TYPE() %>"> --%>
 ...
 <td width="200px" align="center">
  ...
  <td width="200px">
  <select name="is_compleated" class="inputs" required="required">
  ...
  <%-- <input type="text" name="is_compleated" value="<%=item.getSTATUS_AVAILABILITY() %>" class="inputs"> --%>
 ...
 <input type="hidden" name="request" value="fromEditStatus">
