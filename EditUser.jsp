...
List<Inventory_Users> list=(List)session.getAttribute("edit_user_list");
...
<td width="200px">
  ...
  <td width="200px">
  <input type="text" name="user_type" value="<%=user.getUser_type() %>">
...
<td width="200px">
  <select name="user_status">
	...
	<%	
		for(Inventory_Users status:userStatus)
		{
			
			%>
			
			<option value="<%=status.getUser_status()%>"><%=status.getUser_status()%></option>
 ...
 <input type="hidden" name="request" value="from_user_Edit">
