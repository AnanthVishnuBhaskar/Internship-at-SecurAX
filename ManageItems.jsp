 ...
 */
 ...
 function callAddItem()
 {
 	 //alert(data);
        // window.document.location = 'AddItem.jsp?';
          window.document.location = 'AddItemNew.jsp';
 ...
 function callProfile()
 {
 	 //alert(data);
        // window.document.location = 'AddItem.jsp?';
          window.document.location = 'UserProfile.jsp';
...
/* List<Inventory_Users> userList=userDao.getAllUsers();
List<Inventory_Item> itemList=inventoryDao.getAllItemList(); */

 //Inventory_Item_Names.java
 List<Inventory_Item_Names> itemList=inventoryDao.getAllItemNames();
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="#" class="btn btn-default btn-flat" onclick="callProfile();">Profile</a>
                </div>
         ...
         <br>
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> ITEMS</li>
...
<tr style="cursor: pointer;"  onclick="setId('<%=item.getItem_id() %>');">

  
   
 <td width="200px"><%=item.getItem_name()%></td>
 <td width="200px"><%=item.getItem_description()%></td>
 
  <td width="200px"><%=item.getItem_quantity() %></td>
  <td width="200px"><%=item.getItem_stock_quantity() %></td>
