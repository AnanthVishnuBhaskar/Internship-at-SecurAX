        ...
        <!-- Left col -->
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content no-padding">
              ...
              <br>
               <form action="Controller" method="post" name="addItem" id="addItem">
...
<tr >
		<td style="width:100px">MODAL NAME
		</td>
		<td >
		<input class="inputs"   type="text" id="modal_name" name="modal_name" />
		 
		</td>
		<td style="width:auto;">VENDOR NAME
		</td>
		<td >
		<input class="inputs"   type="text" id="vendor_name" name="vendor_name" />
...
<tr class="hideTr">
		...
		<td>
		<input type="number" name="item_price" class="inputs" required="required">
		</td>
	...
	SERIAL NUMBER
		...
		<td>
		<input type="text" name="item_serial_number" class="inputs" required="required" readonly="readonly" value="SLN001">
		</td>
</tr>
<tr class="hideTr">
		<td>
